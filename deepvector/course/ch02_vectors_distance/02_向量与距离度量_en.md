...
>
> **AVX2 + FMA** (Intel 2013, Haswell architecture): 256-bit integer SIMD + FMA (see below). This is DeepVector's **default acceleration baseline** — almost all Intel/AMD CPUs after 2015 support it.
>
