...
> Embedding Service 鈥?the bridge between text and vectors.

## Prerequisites

> 馃搸 **Reference**: [Python Environment](../prerequisites/02_Python鐜_en.md) | [Distance Metrics](../prerequisites/05_璺濈搴﹂噺_en.md)
...
> **Strategy**: MD5 hash 鈫?vector. Persisted to JSON, survives restarts.
...
1. What happens if embedding dimension (384) doesn't match DeepVector config (768)?
