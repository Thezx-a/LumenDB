# Chapter 6 鈥?Metadata & Filtered Search

## Prerequisites

> 馃搸 **Reference**: [Vector Distance Metrics](../prerequisites/05_鍚戦噺璺濈搴﹂噺.md) 鈥?L2, Inner Product, Cosine: formulas and when to use each
> 馃搸 **Reference**: [SIMD & Hardware Optimization](../prerequisites/06_SIMD涓庣‖浠朵紭鍖?md) 鈥?Memory wall and why memory bandwidth matters for vector search
> 馃搸 **Reference**: [Build Environment Configuration](../prerequisites/01_鏋勫缓鐜閰嶇疆_en.md) 鈥?CMake and build commands
...
The vector handles "about climate policy." The constraints 鈥?date, author, programming language, price, availability, rating 鈥?need something else. That something else is **metadata filtering**.
...
A **vector** (also called an **embedding**) is a dense numerical array 鈥?typically 128 to 4096 floating-point numbers 鈥?that captures the *semantic meaning* of a document as a point in high-dimensional space. Two documents with similar meaning produce vectors that are close together in this space, even if they share no words.

> For detailed explanations of vectors, embeddings, and the three distance metrics (L2, Inner Product, Cosine), see Chapter 2: [Vector Fundamentals and Distance Metrics](../ch02_vectors_distance/02_鍚戦噺涓庤窛绂诲害閲廮en.md) and the prerequisite documents listed above.

#### ANN (Approximate Nearest Neighbor)

**ANN** stands for **Approximate Nearest Neighbor**. Finding the *exact* nearest neighbor in high dimensions is slow 鈥?it requires comparing the query vector against every vector in the database (brute force, O(N) time). ANN algorithms trade a small amount of accuracy for dramatic speedups. Instead of guaranteeing the true nearest neighbor, they return a vector that is *likely* near the top-K, often within 95-99% recall.
...
> For a complete explanation of HNSW's multi-layer structure, search algorithm, and hyperparameters, see Chapter 3: [HNSW 鈥?Hierarchical Navigable Small World Graphs](../ch03_hnsw_theory/03_HNSW杩戜技鎼滅储_en.md).
...
Metadata lives in a **metadata store** 鈥?a separate data structure from the vector index. The vector index stores vectors and their IDs; the metadata store maps IDs to their attributes. Keeping them separate means the vector index stays compact and cache-friendly.
...
- **Conjunctive** (AND): all clauses must be true. `A AND B AND C` is true only when A, B, and C are all true. This is *restrictive* 鈥?it narrows results.
- **Disjunctive** (OR): any clause being true is sufficient. `A OR B OR C` is true when at least one of A, B, C is true. This is *expansive* 鈥?it broadens results.
...
- **selectivity 0.01鈥?.10** (1-10%): moderately selective.
...
User query: vector q, filter F
         鈹?         鈻?    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹? Scan metadata   鈹?    鈹? Find IDs where  鈹?    鈹? F is true       鈹?    鈹? 鈫?candidate_ids 鈹?    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?         鈹?         鈻?    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹? ANN search with 鈹?    鈹? candidate_ids   鈹?    鈹? as constraint   鈹?    鈹? 鈫?top-K results 鈹?    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?```
...
```
    ...
    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?              鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹? A 鈹€鈹€ B 鈹€鈹€ C    鈹?              鈹? A 鈹€鈹€ B    C    鈹?    鈹? 鈹?鈺? 鈹? 鈺? 鈹?  鈹?              鈹? 鈹?鈺? 鈹?        鈹?    鈹? D 鈹€鈹€ E 鈹€鈹€ F    鈹?              鈹? D 鈹€鈹€ E    F    鈹?    鈹? 鈹? 鈺?鈹?鈺? 鈹?  鈹?              鈹?      鈺?        鈹?    鈹? G 鈹€鈹€ H 鈹€鈹€ I    鈹?              鈹? G 鈹€鈹€ H         鈹?    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?              鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                                         鈫?C, F, I are
                                         disconnected
```

### 6.2.2 Post-filtering

**How it works**: run the ANN search *first*, retrieving more results than you need (say, top 2脳K or top 3脳K). Then apply the filter to this result set, keeping only matching documents. Return the top K from the survivors.

```
User query: vector q, filter F, top K
         鈹?         鈻?    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹? ANN search      鈹?    鈹? (no filter)     鈹?    鈹? Retrieve top    鈹?    鈹? M = 2K results  鈹?    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?         鈹?         鈻?    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹? Apply filter F  鈹?    鈹? Keep only docs  鈹?    鈹? where F is true 鈹?    鈹? Return top K    鈹?    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?```
...
- Simple implementation 鈥?the filter is just a post-processing step.

**Cons**:
- **Over-fetching**: if the filter is very selective (e.g., only 2% of documents match), you may need to fetch K / 0.02 = 50脳K vectors to get K results after filtering. That's expensive 鈥?you compute 50脳K distances just to throw most of them away.
- **Wasted computation**: distance calculations are performed on vectors that will be discarded.
- **Latency**: fetching 50脳K vectors from disk/network takes time.
...
鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?            鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?鈹?Metadata 鈹傗攢鈹€鈹€鈹€鈻垛攤 Filter   鈹?            鈹?Vector   鈹傗攢鈹€鈹€鈹€鈻垛攤 ANN      鈹?鈹?Store    鈹?    鈹?Engine   鈹?            鈹?Index    鈹?    鈹?Search   鈹?鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹斺攢鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹?            鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹斺攢鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹?                      鈹?                                        鈹?                      鈻?                                        鈻?              鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                          鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?              鈹?Candidate IDs鈹?                          鈹?Top M results鈹?              鈹?(small set)  鈹?                          鈹?(may be large鈹?              鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹€鈹€鈹?                          鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹€鈹€鈹?                     鈹?                                         鈹?                     鈻?                                         鈻?              鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                          鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?              鈹?ANN search   鈹?                          鈹?Filter       鈹?              鈹?(constrained)鈹?                          鈹?(post-filter)鈹?              鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹€鈹€鈹?                          鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹€鈹€鈹?                     鈹?                                         鈹?                     鈻?                                         鈻?              鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                          鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?              鈹?Top K results鈹?                          鈹?Top K results鈹?              鈹?(filtered)   鈹?                          鈹?(filtered)   鈹?              鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                          鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?
...
### 6.2.4 DeepVector's Adaptive Strategy

Neither pre-filtering nor post-filtering is universally better. DeepVector makes the decision at query time based on estimated selectivity:
...
3. If selectivity 鈮?0.10 (10%+ passes): **post-filter**. The ANN graph is mostly intact, so full search + post-filtering preserves recall.
...
## 6.3 The Filter AST 鈥?From Text to Expression Tree
...
### 6.3.1 The Pipeline: String 鈫?Tokens 鈫?AST 鈫?Evaluation

The transformation has three stages:

**Stage 1: Lexical Analysis (Tokenization)**

A **lexer** (also called a **tokenizer** or **scanner**) converts the raw character string into a sequence of **tokens**. A token is a categorized chunk of the input 鈥?the smallest meaningful unit. The lexer discards whitespace and comments, and classifies each token by type.

For the input `date >= 2024 AND source = "wiki"`:

```
Token 1: IDENTIFIER("date")     鈥?a field name
Token 2: GTE(">=")              鈥?a comparison operator
Token 3: INTEGER(2024)          鈥?a numeric literal
Token 4: AND("AND")             鈥?a logical connective
Token 5: IDENTIFIER("source")   鈥?a field name
Token 6: EQ("=")                鈥?a comparison operator
Token 7: STRING("wiki")         鈥?a string literal
```
...
A **parser** converts the token stream into an **Abstract Syntax Tree (AST)**, also called an **expression tree**. The AST is a tree data structure that captures the *structure* of the expression 鈥?what depends on what 鈥?independent of the concrete syntax.
...
This is inherently **recursive** 鈥?each node delegates to its children. The evaluation naturally handles nested expressions.

### 6.3.2 The Recursive Descent Parser

A **recursive descent parser** is the simplest way to implement a parser for a small language. It is a **top-down parser** 鈥?it starts at the root of the AST and works downward, calling itself recursively for sub-expressions.
...
Each function consumes tokens at its precedence level. The `or_expr` function calls `and_expr`, which calls `comparison`, which handles the leaf comparisons. This nesting ensures that `A AND B OR C` is parsed as `(A AND B) OR C` 鈥?the OR at the top level sees the result of AND as its operands.
...
The AST is a plain data structure 鈥?no virtual functions, no inheritance. This makes it trivially serializable (for caching or network transfer) and cache-friendly (the compiler lays out nodes contiguously in a `std::vector<FilterNode>`).

---

## 6.4 The FieldAccessor Pattern

Once we have the AST, we need to evaluate it against actual documents. The naive approach: for every filter check, deserialize the entire metadata blob into a struct, then access the field. This is slow 鈥?most of the work is wasted on fields the filter doesn't reference.

Instead, DeepVector uses the **FieldAccessor** pattern. For each field in the schema, we store:
...
FieldAccessor decouples filter evaluation from storage. MiniKV doesn't need to know about the metadata schema 鈥?it just stores binary blobs and passes them to the evaluator with the right accessor table. This means you can change the schema without touching MiniKV.
...
Compare this to JSON deserialization, which requires: parsing the JSON string, allocating `std::string` objects for keys, converting values from text to numbers, building a `std::unordered_map<std::string, std::any>` 鈥?all per-document, all per-query. The FieldAccessor approach does none of this.
...
- `"700" > "2000"` 鈫?TRUE (because '7' > '2' in the first character position)

But the user meant numeric comparison:
- `700 > 2000` 鈫?FALSE

This is the classic "string vs. number" confusion that has plagued CSV files, JavaScript, and loosely-typed databases since the beginning. DeepVector handles it explicitly: the schema declares each field's type, and comparison operators use the appropriate comparison.

For fields that might be either (user-uploaded data), DeepVector uses a `tryNumeric()` strategy:
...
For DeepVector, the default is to **NOT index metadata fields** 鈥?because the typical use case is batch inserts followed by many reads, and the read path already has a fast filter evaluator. Indexing is opt-in, recommended only when profiling shows a bottleneck.
...
Accurate selectivity estimation is one of the hardest problems in **query optimization** 鈥?the process by which a database decides the best execution plan for a query. Commercial databases (Oracle, SQL Server) invest decades of research into histograms, sketches, and sampling. DeepVector takes a pragmatic approach.

### 6.7.1 Equal-Width Histograms

For integer fields, DeepVector maintains an **equal-width histogram**: divide the range [min, max] into B buckets, count how many documents have values in each bucket.
...
To estimate `P(date >= 2024)`: find which buckets overlap with [2024, 鈭瀅, sum their counts, divide by total_count. For `P(source = "wiki")`: count the number of documents with source = wiki, divided by total_count (stored as per-value counters, not a histogram).
...
This assumes A and B are **independent** 鈥?knowing that a document satisfies A tells you nothing about whether it satisfies B. They often aren't independent. For example, `source = "wiki"` and `word_count > 10000` might be correlated (Wikipedia articles tend to be long). When the assumption breaks, we might choose pre-filtering when post-filtering would be better, or vice versa.

The real cost of a wrong selectivity estimate is rarely catastrophic for vector search 鈥?the worst case is we fetch a few extra candidates or do a few extra distance computations. This isn't a SQL join where a bad estimate can turn a 1-second query into a 1-hour query.
...
## 6.8 Integration with ANN Search 鈥?Full Pipeline

### Filter Pipeline Overview

```mermaid
flowchart TD
    A[User Query + Filter] --> B[Parse Filter String 鈫?AST]
...
User query arrives:
  ...
  filter f = "date >= 2024 AND source = 'wiki'"
                    鈹?                    鈻?  鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?  鈹?1. Parse filter string 鈫?AST       鈹?  鈹?   FilterNode f = {AND,            鈹?  鈹?     {GT, "date", 2024},           鈹?  鈹?     {EQ, "source", "wiki"}}       鈹?  鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                    鈹?                    鈻?  鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?  鈹?2. Estimate selectivity            鈹?  鈹?   P(date>=2024) = 0.30            鈹?  鈹?   P(source=wiki) = 0.15           鈹?  鈹?   P(AND) = 0.30 脳 0.15 = 0.045    鈹?  鈹?   0.045 < 0.10 鈫?PRE-FILTER       鈹?  鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                    鈹?                    鈻?  鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?  鈹?3. Pre-filter                      鈹?  鈹?   candidate_ids = []              鈹?  鈹?   for each doc in metadata_store: 鈹?  鈹?       if eval(f, doc):            鈹?  鈹?           candidate_ids += doc.id 鈹?  鈹?   鈫?4.5% of docs match            鈹?  鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                    鈹?                    鈻?  鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?  鈹?4. Constrained ANN search          鈹?  鈹?   hnsw.Search(q, top_k=10,        鈹?  鈹?                allowed=candidate_ids)鈹?  鈹?   鈫?results with metadata         鈹?  鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?```
...
2. **Selectivity estimation drives the strategy** 鈥?the system adapts based on how selective the filter is.
3. **Bitmap intersections** are used for high-selectivity conjunctive filters.
4. **Over-fetching with post-filter** is the safe default 鈥?it preserves recall at the cost of extra computation.

---

## Code Exercise

### Part A 鈥?Filter AST Evaluator
...
### Part B 鈥?Flat-File Metadata Store
...
- **Bonus**: for `tags` field with EQ, pre-build a hash map `tag 鈫?vector<int> indices`. Use it to accelerate queries that filter by a single tag.

### Part C 鈥?Selectivity Estimator
