...
> DeepVector 是一个 C++ 零拷贝向量数据库，AgenticDB 在其上构建了智能检索层。
...
AgenticDB 不是一个独立的项目，而是在 DeepVector C++ 向量数据库之上**增加了一层 Python Agent 层**，使数据库具备以下能力：
