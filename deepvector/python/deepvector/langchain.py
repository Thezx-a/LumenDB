"""
LangChain integration for DeepVector.
...
class DeepVectorVectorStore(VectorStore if VectorStore is not object else object):
    """LangChain-compatible vector store backed by DeepVector."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        from deepvector._deepvector import Collection, CollectionConfig
