...
<h1 align="center">LumenDB 从零到一</h1>
...
```mermaid
graph LR
    COURSE[LumenDB 教程] --> LDB[LumenDB<br/>向量数据库]
...
| 仓库 | 说明 |
|------|------|
| [LumenDB](https://github.com/Thezx-a/LumenDB) | 向量数据库主仓库 |
...
- [LumenDB 面试 78 题](https://github.com/Thezx-a/LumenDB/blob/main/INTERVIEW_QA.md)
