...
> MCP (Model Context Protocol) — plug-and-play LumenDB for any Agent framework.
...
```
Traditional:
  Agent Framework → Adapter → LumenDB SDK → LumenDB
                      ↑
                One per framework
...
3. Create a LangChain Agent using LumenDB MCP tools
