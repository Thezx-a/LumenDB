...
project(LumenDB-py VERSION 0.1.0 LANGUAGES CXX)
...
name = "lumen-db"
version = "0.1.0"
description = "LumenDB Python bindings"
requires-python = ">=3.8"
...
- **VectorStores**: Store and retrieve vectors—this is LumenDB's entry point
...
class LumenDBLangChainRetriever(BaseRetriever):
    db: _lumen_retriever.LumenDBRetriever
