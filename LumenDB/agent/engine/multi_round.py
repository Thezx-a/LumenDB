...
class MultiRoundEngine:
    ...
    async def _ensure_client(self):
        """确保 LumenDB HTTP 客户端已初始化 / Ensure HTTP client initialized."""
    ...
    async def _execute_search(
        ...
        """
        执行单次搜索 / Execute a single search against LumenDB.
    ...
    async def _fetch_meta(
        ...
        注意: 当前 LumenDB HTTP API 暂未提供通过 id 获取元数据的端点。
